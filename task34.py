...
#с клавиатуры. В ответе напишите “Парам пам-пам”, если с ритмом все в порядке и “Пам парам”, если с ритмом 
#все не в порядке
#*Пример:*
...
# poem = "пар-ра-рам рам-папам па-па-да"
poem = input('Введите кричалку Винни-Пуха: ')
if isRithm(poem, lst_alfa):
    print("Парам пам-пам")
else:
    print("Пам парам")